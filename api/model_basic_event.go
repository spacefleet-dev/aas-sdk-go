...
// BasicEvent struct for BasicEvent
...
// NewBasicEvent instantiates a new BasicEvent object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBasicEvent(modelType ModelType, observed Reference) *BasicEvent {
	this := BasicEvent{}
...
// NewBasicEventWithDefaults instantiates a new BasicEvent object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewBasicEventWithDefaults() *BasicEvent {
	this := BasicEvent{}
	return &this
}

// GetExtensions returns the Extensions field value if set, zero value otherwise.
func (o *BasicEvent) GetExtensions() []Extension {
...
func (o *BasicEvent) GetExtensionsOk() ([]Extension, bool) {
	if o == nil || o.Extensions == nil {
		return nil, false
	}
...
func (o *BasicEvent) HasExtensions() bool {
	if o != nil && o.Extensions != nil {
		return true
	}
...
func (o *BasicEvent) SetExtensions(v []Extension) {
	o.Extensions = v
}

// GetCategory returns the Category field value if set, zero value otherwise.
func (o *BasicEvent) GetCategory() string {
...
// and a boolean to check if the value has been set.
func (o *BasicEvent) GetCategoryOk() (*string, bool) {
	if o == nil || o.Category == nil {
		return nil, false
	}
...
func (o *BasicEvent) HasCategory() bool {
	if o != nil && o.Category != nil {
		return true
	}
...
func (o *BasicEvent) SetCategory(v string) {
	o.Category = &v
}

// GetChecksum returns the Checksum field value if set, zero value otherwise.
func (o *BasicEvent) GetChecksum() string {
...
// and a boolean to check if the value has been set.
func (o *BasicEvent) GetChecksumOk() (*string, bool) {
	if o == nil || o.Checksum == nil {
		return nil, false
	}
...
func (o *BasicEvent) HasChecksum() bool {
	if o != nil && o.Checksum != nil {
		return true
	}
...
func (o *BasicEvent) SetChecksum(v string) {
	o.Checksum = &v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *BasicEvent) GetDescription() []LangString {
...
// and a boolean to check if the value has been set.
func (o *BasicEvent) GetDescriptionOk() ([]LangString, bool) {
	if o == nil || o.Description == nil {
		return nil, false
	}
...
func (o *BasicEvent) HasDescription() bool {
	if o != nil && o.Description != nil {
		return true
	}
...
func (o *BasicEvent) SetDescription(v []LangString) {
	o.Description = v
}

// GetDisplayName returns the DisplayName field value if set, zero value otherwise.
func (o *BasicEvent) GetDisplayName() []LangString {
...
// and a boolean to check if the value has been set.
func (o *BasicEvent) GetDisplayNameOk() ([]LangString, bool) {
	if o == nil || o.DisplayName == nil {
		return nil, false
	}
...
func (o *BasicEvent) HasDisplayName() bool {
	if o != nil && o.DisplayName != nil {
		return true
	}
...
func (o *BasicEvent) SetDisplayName(v []LangString) {
	o.DisplayName = v
}

// GetIdShort returns the IdShort field value if set, zero value otherwise.
func (o *BasicEvent) GetIdShort() string {
...
// and a boolean to check if the value has been set.
func (o *BasicEvent) GetIdShortOk() (*string, bool) {
	if o == nil || o.IdShort == nil {
		return nil, false
	}
...
func (o *BasicEvent) HasIdShort() bool {
	if o != nil && o.IdShort != nil {
		return true
	}
...
func (o *BasicEvent) SetIdShort(v string) {
	o.IdShort = &v
}

// GetModelType returns the ModelType field value
func (o *BasicEvent) GetModelType() ModelType {
	if o == nil {
		var ret ModelType
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BasicEvent) GetModelTypeOk() (*ModelType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BasicEvent) SetModelType(v ModelType) {
	o.ModelType = v
}

// GetKind returns the Kind field value if set, zero value otherwise.
func (o *BasicEvent) GetKind() ModelingKind {
	if o == nil || o.Kind == nil {
...
// and a boolean to check if the value has been set.
func (o *BasicEvent) GetKindOk() (*ModelingKind, bool) {
	if o == nil || o.Kind == nil {
		return nil, false
	}
	return o.Kind, true
...
func (o *BasicEvent) HasKind() bool {
	if o != nil && o.Kind != nil {
		return true
	}
...
func (o *BasicEvent) SetKind(v ModelingKind) {
	o.Kind = &v
}

// GetSemanticId returns the SemanticId field value if set, zero value otherwise.
func (o *BasicEvent) GetSemanticId() Reference {
...
// and a boolean to check if the value has been set.
func (o *BasicEvent) GetSemanticIdOk() (*Reference, bool) {
	if o == nil || o.SemanticId == nil {
		return nil, false
	}
...
func (o *BasicEvent) HasSemanticId() bool {
	if o != nil && o.SemanticId != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *BasicEvent) GetSupplementalSemanticIdsOk() ([]Reference, bool) {
	if o == nil || o.SupplementalSemanticIds == nil {
		return nil, false
	}
...
func (o *BasicEvent) HasSupplementalSemanticIds() bool {
	if o != nil && o.SupplementalSemanticIds != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *BasicEvent) GetQualifiersOk() ([]Qualifier, bool) {
	if o == nil || o.Qualifiers == nil {
		return nil, false
	}
...
func (o *BasicEvent) HasQualifiers() bool {
	if o != nil && o.Qualifiers != nil {
		return true
	}
...
func (o *BasicEvent) SetQualifiers(v []Qualifier) {
	o.Qualifiers = v
}

// GetEmbeddedDataSpecifications returns the EmbeddedDataSpecifications field value if set, zero value otherwise.
func (o *BasicEvent) GetEmbeddedDataSpecifications() []EmbeddedDataSpecification {
...
// and a boolean to check if the value has been set.
func (o *BasicEvent) GetEmbeddedDataSpecificationsOk() ([]EmbeddedDataSpecification, bool) {
	if o == nil || o.EmbeddedDataSpecifications == nil {
		return nil, false
	}
...
func (o *BasicEvent) HasEmbeddedDataSpecifications() bool {
	if o != nil && o.EmbeddedDataSpecifications != nil {
		return true
	}
...
func (o *BasicEvent) SetEmbeddedDataSpecifications(v []EmbeddedDataSpecification) {
	o.EmbeddedDataSpecifications = v
}

// GetObserved returns the Observed field value
func (o *BasicEvent) GetObserved() Reference {
	if o == nil {
		var ret Reference
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BasicEvent) GetObservedOk() (*Reference, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BasicEvent) SetObserved(v Reference) {
	o.Observed = v
}

func (o BasicEvent) MarshalJSON() ([]byte, error) {
...
type NullableBasicEvent struct {
	value *BasicEvent
	isSet bool
}

func (v NullableBasicEvent) Get() *BasicEvent {
	return v.value
}

func (v *NullableBasicEvent) Set(val *BasicEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableBasicEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableBasicEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBasicEvent(val *BasicEvent) *NullableBasicEvent {
	return &NullableBasicEvent{value: val, isSet: true}
}

func (v NullableBasicEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBasicEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
