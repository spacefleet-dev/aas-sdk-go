...
func NewBlob(modelType ModelType, contentType string) *Blob {
	this := Blob{}
...
func (o *Blob) GetExtensions() []Extension {
...
func (o *Blob) GetExtensionsOk() ([]Extension, bool) {
	if o == nil || o.Extensions == nil {
		return nil, false
	}
...
func (o *Blob) HasExtensions() bool {
	if o != nil && o.Extensions != nil {
		return true
	}
...
func (o *Blob) SetExtensions(v []Extension) {
	o.Extensions = v
}

// GetCategory returns the Category field value if set, zero value otherwise.
func (o *Blob) GetCategory() string {
...
// and a boolean to check if the value has been set.
func (o *Blob) GetCategoryOk() (*string, bool) {
	if o == nil || o.Category == nil {
		return nil, false
	}
...
func (o *Blob) SetCategory(v string) {
	o.Category = &v
}

// GetChecksum returns the Checksum field value if set, zero value otherwise.
func (o *Blob) GetChecksum() string {
...
// and a boolean to check if the value has been set.
func (o *Blob) GetChecksumOk() (*string, bool) {
	if o == nil || o.Checksum == nil {
		return nil, false
	}
...
func (o *Blob) SetChecksum(v string) {
	o.Checksum = &v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *Blob) GetDescription() []LangString {
...
// and a boolean to check if the value has been set.
func (o *Blob) GetDescriptionOk() ([]LangString, bool) {
	if o == nil || o.Description == nil {
		return nil, false
	}
...
func (o *Blob) HasDescription() bool {
	if o != nil && o.Description != nil {
		return true
	}
...
func (o *Blob) SetDescription(v []LangString) {
	o.Description = v
}

// GetDisplayName returns the DisplayName field value if set, zero value otherwise.
func (o *Blob) GetDisplayName() []LangString {
...
// and a boolean to check if the value has been set.
func (o *Blob) GetDisplayNameOk() ([]LangString, bool) {
	if o == nil || o.DisplayName == nil {
		return nil, false
	}
...
func (o *Blob) HasDisplayName() bool {
	if o != nil && o.DisplayName != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Blob) GetIdShortOk() (*string, bool) {
	if o == nil || o.IdShort == nil {
		return nil, false
	}
...
func (o *Blob) SetIdShort(v string) {
	o.IdShort = &v
}

// GetModelType returns the ModelType field value
func (o *Blob) GetModelType() ModelType {
	if o == nil {
		var ret ModelType
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Blob) GetModelTypeOk() (*ModelType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Blob) SetModelType(v ModelType) {
	o.ModelType = v
}

// GetKind returns the Kind field value if set, zero value otherwise.
func (o *Blob) GetKind() ModelingKind {
	if o == nil || o.Kind == nil {
...
// and a boolean to check if the value has been set.
func (o *Blob) GetKindOk() (*ModelingKind, bool) {
	if o == nil || o.Kind == nil {
		return nil, false
	}
	return o.Kind, true
...
// and a boolean to check if the value has been set.
func (o *Blob) GetSemanticIdOk() (*Reference, bool) {
	if o == nil || o.SemanticId == nil {
		return nil, false
	}
...
func (o *Blob) HasSemanticId() bool {
	if o != nil && o.SemanticId != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Blob) GetSupplementalSemanticIdsOk() ([]Reference, bool) {
	if o == nil || o.SupplementalSemanticIds == nil {
		return nil, false
	}
...
func (o *Blob) HasSupplementalSemanticIds() bool {
	if o != nil && o.SupplementalSemanticIds != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Blob) GetQualifiersOk() ([]Qualifier, bool) {
	if o == nil || o.Qualifiers == nil {
		return nil, false
	}
...
func (o *Blob) HasQualifiers() bool {
	if o != nil && o.Qualifiers != nil {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Blob) GetEmbeddedDataSpecificationsOk() ([]EmbeddedDataSpecification, bool) {
	if o == nil || o.EmbeddedDataSpecifications == nil {
		return nil, false
	}
...
func (o *Blob) HasEmbeddedDataSpecifications() bool {
	if o != nil && o.EmbeddedDataSpecifications != nil {
		return true
	}
...
func (o *Blob) SetEmbeddedDataSpecifications(v []EmbeddedDataSpecification) {
...
// and a boolean to check if the value has been set.
func (o *Blob) GetValueOk() (*string, bool) {
	if o == nil || o.Value == nil {
		return nil, false
	}
	return o.Value, true
